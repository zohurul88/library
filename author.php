      ...
      <div class="box">
        <div class="box-header with-border">
			<div class="box box-primary">
				...
				<form role="form" method="POST" action="http://localhost/library/author-submit.php">
				  <div class="box-body">
					<div class="form-group">
					  <label for="category">Author Name</label>
					  <input type="text" name="author" class="form-control" id="category" placeholder="Enter Author Name">
					</div>
				  </div>
				  <!-- /.box-body -->
